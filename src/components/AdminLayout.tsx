...
import { Users, FileText, UserCog, MonitorCheck, LayoutDashboard, LogOut, KeyRound, BookOpen } from "lucide-react";
import { cn } from "@/lib/utils";
import TopNavBar from "./TopNavBar";
import { useAuth } from "@/contexts/AuthContext";
import ChangePasswordModal from "@/components/modals/ChangePasswordModal";
import { AdminOverviewModal, STORAGE_KEY } from "@/components/modals/AdminOverviewModal";
...
const AdminLayout = ({ children }: AdminLayoutProps) => {
  ...
  const navItems = [
    ...
    { name: "Generated Documents", path: "/admin/generated-documents", icon: FileText },
    { name: "Manage Users", path: "/admin/manage-users", icon: UserCog },
    { name: "Profile Management", path: "/admin/profile-management", icon: MonitorCheck },
  ];
