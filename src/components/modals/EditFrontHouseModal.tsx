...
interface EditFrontHouseModalProps {
  isOpen: boolean;
  onClose: () => void;
  record: any;
...
const EditFrontHouseModal = ({ isOpen, onClose, record, onUpdate, clientId }: EditFrontHouseModalProps) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Edit Front of House Record</DialogTitle>
        </DialogHeader>
...
export default EditFrontHouseModal;
