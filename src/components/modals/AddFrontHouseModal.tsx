...
interface AddFrontHouseModalProps {
  isOpen: boolean;
  onClose: () => void;
  onAdd: (record: any) => Promise<void>;
}

const AddFrontHouseModal = ({ isOpen, onClose, onAdd }: AddFrontHouseModalProps) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Add Front of House Record</DialogTitle>
        </DialogHeader>
...
export default AddFrontHouseModal;
